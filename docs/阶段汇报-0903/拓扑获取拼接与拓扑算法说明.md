...
- `test/go/group4_full_real_algorithm/testdata/input/kubernetes-nodes.json`

拓扑与 Node 数据由 `test/go/common/fixture.go` 的 `GenerateFixture(1000)` 统一生成。
...
```text
test/go/group4_full_real_algorithm/results/<时间戳>/actual/
├── ngd-input.yaml
...
| Group4 全链路测试 | `test/go/group4_full_real_algorithm/group4_test.go` |
| 1000 Node Fixture 与上层拓扑生成 | `test/go/common/fixture.go` |
| Group4 拓扑输入 | `test/go/group4_full_real_algorithm/testdata/input/network-topology.yaml` |
| Group4 NGD 输入 | `test/go/group4_full_real_algorithm/testdata/input/ngd.yaml` |
