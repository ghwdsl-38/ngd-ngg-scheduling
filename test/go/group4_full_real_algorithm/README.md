...
b test/go/group4_full_real_algorithm/group4_test.go:177
...
b test/go/group4_full_real_algorithm/group4_test.go:206
breakpoints
c
```
...
```text
test/go/group4_full_real_algorithm/group4_test.go:177
```
...
```text
test/go/group4_full_real_algorithm/group4_test.go:206
```
...
```text
test/go/group4_full_real_algorithm/results/<run-id>/
├── actual/
│   ├── ngd-input.yaml
