...
```bash
./test/legacy/group3_full_chain/run-group.sh --mode timing
./test/legacy/group3_full_chain/run-group.sh --mode evidence
```
...
```json
{"status":"PASS","result":".../test/legacy/group3_full_chain/runs/<run-id>"}
```
